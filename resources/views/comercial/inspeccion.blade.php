                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row" style="padding: 15px 15px" id="plan-saneamiento">
                                        <div class="form-group col-lg-2">
                                            ...
                                            <input type="number" min=0 name="num_visita" id="num_visita" placeholder="Ej: 1"
                                                class="form-control">
                                        </div>
                                        <div class="form-group col-lg-4 b-r">
                                            ...
                                            <div class="input-group">
                                                <input style="width: 40%;margin-right: 10px;" type="number" min="0" max="11"
                                                    class="form-control" id="num_horas" placeholder="Horas">
                                                <input style="width: 42%;margin-left: 10px;" type="number" min="0" max="60"
                                                    class="form-control" id="num_minutos" placeholder="Minutos">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <textarea class="form-control" placeholder="Escriba aquí las observaciones que desee."
                                            rows="1" name="instrucciones" id="instrucciones"></textarea>
                                    </div>
                                    ...
                                    <div class="row" id="detalle-servicios" style="padding: 15px 15px;">
                                        ...
                                        <div class="form-group col-lg-2">
                                            ...
                                            <input type="number" min=0 name="valor_servicio_detalle" id="total_plan"
                                        ...
                                        <div class="form-group col-lg-4">
                                            <label>Observaciones</label>
                                            <textarea class="form-control" placeholder="Escriba aquí las observaciones que desee."
                                                rows="1" name="observacion_servicio_detalle" id="observacion_servicio_detalle"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <textarea name="total_servicio_detalle" id="total_servicio_detalle" placeholder="Escriba aquí las observaciones"
                                    ...
                                    <div class="row" id="compra-dispositivos" style="padding: 15px 15px">
                                        ...
                                        <div class="form-group col-lg-1">
                                            ...
                                            <input type="text" id="dispositivos_1" name="dispositivos_1" placeholder=""
                                                class="form-control">
                                        </div>

                                        <div class="form-group col-lg-2">
                                            <label class="control-label">Valor unitario sin IVA</label>
                                            <input type="text" id="dispositivos_1" name="dispositivos_1" placeholder="Nombre de dispositivo"
                                                class="form-control">
                                        </div>
