                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <textarea style="text-transform: uppercase" style="text-transform: uppercase"
                                            ...
                                            name="instrucciones" id="observaciones_tecnico" required></textarea>
                                    </div>
                                    ...
                                    <div class="row" id="detalle-servicios" style="padding: 15px 15px;">
                                        ...
                                        <div class="form-group col-lg-2">
                                            ...
                                            <input type="text" min=0 name="valor_servicio_detalle-0"
                                                id="valor_servicio_detalle-0" placeholder="Valor total"
                                                class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-2">
                                            ...
                                            <select style="text-transform: uppercase"
                                                name="frecuencia_servicio_detalle-0" id="frecuencia_servicio_detalle-0"
                                                class="form-control" required>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="number" min=0 name="total_servicio_detalle"
                                            id="total_servicio_detalle" placeholder="Valor total" class="form-control"
                                            readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="number" min=0 name="cantidad_lampara_lamina"
                                            id="cantidad_lampara_lamina" placeholder="Valor total" class="form-control">
                                    </div>

                                    <div class="form-group col-lg-3">
                                        <label class="control-label">Lámpara insectocutora</label>
                                        <input type="number" min=0 name="cant_lampara_insectocutora"
                                            id="cant_lampara_insectocutora" placeholder="Valor total"
                                            class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="number" min=0 name="cant_estaciones_roedor"
                                            id="cant_estaciones_roedor" placeholder="Valor total" class="form-control">
                                    </div>
                                    ...
                                    <div class="row" id="dispositivos" style="padding: 15px 15px">
                                        ...
                                        <div class="form-group col-lg-2">
                                            ...
                                            <input type="text" id="valor_sin_iva_dispositivo-0"
                                                name="valor_sin_iva_dispositivo-0" placeholder="Nombre de dispositivo"
                                                class="form-control">
                                        </div>
                                    ...
                                    <div class="row" id="dispositivos-comodato" style="padding: 15px 15px">
                                        ...
                                        <div class="form-group col-lg-2">
                                            ...
                                            <input type="text" id="valor_sin_iva_dispositivo_comodato-0"
                                                name="valor_sin_iva_dispositivo_comodato-0"
                                                placeholder="Nombre de dispositivo" class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" id="total_dispositivo_comodato-0"
                                                name="total_dispositivo_comodato-0" placeholder="Nombre de dispositivo"
                                                class="form-control">
                                        </div>
                                    ...
                                    <div class="row" id="gestion-calidad" style="padding: 15px 15px">
                                        <div class="form-group col-lg-4">
                                            ...
                                            <select style="text-transform: uppercase" id="tipo_doc-0" name="tipo_doc-0"
                                                class="form-control">
                                                <option value="" selected>Seleccione una opción</option>
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <select style="text-transform: uppercase" id="frecuencia_doc-0"
                                                name="frecuencia_doc-0" class="form-control">
                                                <option value="" selected>Seleccione una opción</option>
                                                <option value="mensual">Mensual</option>
                                                <option value="semanal">Semanal</option>
                                                <option value="quincenal">Quincenal</option>
                                    ...
                                    <div class="row" id="areas" style="padding: 15px 15px">
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" style="text-transform: uppercase" id="area-0"
                                                name="area-0" placeholder="Nombre de area" class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <select style="text-transform: uppercase"
                                                data-placeholder="Seleccione las opciones" multiple style="width:350px;"
                                                id="plagas_area-0">
...
<script>
    ...
    function getInspectionForm(dataInspection) {
        ...
        dataInspection.detalle_servicios.forEach((value, index) => {
            if (index === 0) {
                $("#servicio_detalle-0").val(value.tipo_servicio).change();
                $("#valor_servicio_detalle-0").val(value.valor_servicio);
                $("#frecuencia_servicio_detalle-0").val(value.frecuencia_servicio).change();
                ...
                valoresServicios[index] = new AutoNumeric(document.getElementById(
                    `valor_servicio_detalle-${index}`), {
                    digitalGroupSpacing: '3',
                    digitGroupSeparator: '.',
                    decimalCharacter: ',',
                    decimalPlaces: 0,
        ...
        dataInspection.residencias.forEach((value, index) => {
            ...
            if (index === 0) {
                ...
                `)
                valoresResidencias[index] = new AutoNumeric(document.getElementById(
                    `valor_residencia-${index}`), {
                        digitalGroupSpacing: '3',
                        digitGroupSeparator: '.',
                        decimalCharacter: ',',
                        decimalPlaces: 0,
        ...
        dataInspection.compra_dispositivos.forEach((value, index) => {
            if (index === 0) {
                ...
                valoresSinIvaDispositivos[0] = new AutoNumeric(document.getElementById(
                    'valor_sin_iva_dispositivo-0'), {
                    digitalGroupSpacing: '3',
                    digitGroupSeparator: '.',
                    decimalCharacter: ',',
                    decimalPlaces: 0,
                ...
                `)
                valoresSinIvaDispositivos[index] = new AutoNumeric(document.getElementById(
                    `valor_sin_iva_dispositivo-${index}`), {
                    digitalGroupSpacing: '3',
                    digitGroupSeparator: '.',
                    decimalCharacter: ',',
                    decimalPlaces: 0,
                ...
                valorTotalDispositivos[index] = new AutoNumeric(document.getElementById(
                    `total_dispositivo-${index}`), {
                    digitalGroupSpacing: '3',
                    digitGroupSeparator: '.',
                    decimalCharacter: ',',
                    decimalPlaces: 0,
        ...
        dataInspection.dispositivos_comodato.forEach((value, index) => {
            if (index === 0) {
                ...
                valorTotalComodato[0] = new AutoNumeric(document.getElementById(
                'total_dispositivo_comodato-0'), {
                    digitalGroupSpacing: '3',
                    digitGroupSeparator: '.',
                    decimalCharacter: ',',
                    decimalPlaces: 0,
                ...
                `)
                valoresSinIvaComodato[index] = new AutoNumeric(document.getElementById(
                    `valor_sin_iva_dispositivo_comodato-${index}`), {
                    digitalGroupSpacing: '3',
                    digitGroupSeparator: '.',
                    decimalCharacter: ',',
                    decimalPlaces: 0,
                ...
                valorTotalComodato[index] = new AutoNumeric(document.getElementById(
                    `total_dispositivo_comodato-${index}`), {
                    digitalGroupSpacing: '3',
                    digitGroupSeparator: '.',
                    decimalCharacter: ',',
                    decimalPlaces: 0,
        ...
        dataInspection.gestion_calidad.forEach((value, index) => {
            if (index === 0) {
                $("#tipo_doc-0").val(value.tipo_documento).change();
                $("#frecuencia_doc-0").val(value.frecuencia_documento).change();
                ...
                $('#gestion-calidad').append(`
                    <div class="form-group col-lg-4">
                        ...
                        <select style="text-transform: uppercase" id="tipo_doc-${index}"
                            class="form-control" name="tipo_doc-${index}">
                            <option value="" selected>Seleccione una opción</option>
                            <option value="diagnostico_inicial">Diagnósticos</option>
                            <option value="cronograma_servicios">Cronograma de servicios</option>
                            <option value="mapas_dispositivos">Mapa de dispositivos</option>
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <select style="text-transform: uppercase"  id="frecuencia_doc-${index}"
                            class="form-control" name="frecuencia_doc-${index}">
                            <option value="" selected>Seleccione una opción</option>
                            <option value="mensual">Mensual</option>
                            <option value="semanal">Semanal</option>
                            <option value="quincenal">Quincenal</option>
                ...
                $(`#tipo_doc-${index}`).val(value.tipo_documento).change();
                $(`#frecuencia_doc-${index}`).val(value.frecuencia_documento).change();
            }
            contDocs++;
        })
        ...
        dataInspection.areas.forEach((value, index) => {
            ...
            if (index === 0) {
                ...
                $("#nivel_area-0").val(value.nivel_actividad_area).change();
            } else {
                $("#areas").append(`
                    <div class="form-group col-lg-3">
                        <label class="control-label">Nombre y/o descripción del área</label>
                    ...
                    <div class="form-group col-lg-2">
                        <label class="control-label">Nivel act.</label>
                        <select style="text-transform: uppercase" id="nivel_area-${index}" name="nivel_area-${index}" class="form-control" required>
                            <option value="alto">ALTO</option>
                            <option value="medio">MEDIO</option>
                            <option value="bajo">BAJO</option>
                            <option value="no" selected>NO</option>
                ...
                $(`#nivel_area-${index}`).val(value.nivel_actividad_area).change();
            }
            contAreas++;
        })
    }
    ...
    $("#btn-add-dispositivo").click(function () {
        ...
        valorTotalDispositivos[contDispositivos] = new AutoNumeric(document.getElementById(
            `total_dispositivo-${contDispositivos}`), {
            digitalGroupSpacing: '3',
            digitGroupSeparator: '.',
            decimalCharacter: ',',
            decimalPlaces: 0,
    ...
    $("#btn-add-dispositivo-comodato").click(function () {
        ...
        valorTotalComodato[contComodatos] = new AutoNumeric(document.getElementById(
            `total_dispositivo_comodato-${contComodatos}`), {
            digitalGroupSpacing: '3',
            digitGroupSeparator: '.',
            decimalCharacter: ',',
            decimalPlaces: 0,
