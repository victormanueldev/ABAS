    ...
    function getInspectionForm(dataInspection) {
        ...
        dataInspection.areas.forEach((value,index) => {
            ...
            if (index === 0) {
                ...
                minutes = (value.tiempo_estimado % 60);
                $("#area-0").val();
                $("#num_horas_area-0").val();
                $("#num_minutos_area-0").val();
                $("#plagas_area-0").val();
                $("#nivel_area-0").val();
            }else{
                $("#areas").append(`
                    ...
                    <div class="form-group col-lg-4">
                        <label class="control-label">Evidencia y/o plaga observada</label>
                        <select style="text-transform: uppercase" data-placeholder="Seleccione las opciones" class="chosen-select" multiple style="width:350px;" tabindex="4" id="plagas_area-${index}">
                            <option value="cucarachas">CUCARACHAS</option>
                            <option value="moscas">MOSCAS</option>
                            <option value="pulgas">PULGAS</option>
                            <option value="hormigas">HORMIGAS</option>
                    ...
                    <div class="form-group col-lg-2">
                        <label class="control-label">Nivel act.</label>
                        <select style="text-transform: uppercase" name="nivel_area-${index}" id="nivel_area-${index}" class="form-control">
