...
<div class="wrapper wrapper-content animated fadeInRight" id="clientes">
    <div class="row">
        ...
        ---------------------------------------->
        <div class="col-lg-12" id="form-ods">
...
<script>
    ...
    var servicio;
    const idServicioSeleccionado = window.location.pathname.split('/')[2];
    ...
    $(document).ready(function () {
        ...
        // Peticion para consultar el servicio seleccionado
        $.get(`/servicios/${idServicioSeleccionado}`)
            .then(res => {
                if(res){
                    servicio = res[0];
