...
Vue.component('tareas', __webpack_require__(35));

var app = new Vue({
    el: '#tareas'
});

Vue.component('novedades', __webpack_require__(38));

var novedad = new Vue({
    el: '#novedad'
});

Vue.component('notificaciones', __webpack_require__(43));

var notificacion = new Vue({
    el: '#notificacion'
});

Vue.component('documentos', __webpack_require__(46));

var documentos = new Vue({
    el: '#documentos'
});

Vue.component('novedades-temporales', __webpack_require__(49));

var temporales = new Vue({
    el: '#temporales'
});
...
Component.options.__file = "resources/assets/js/components/novedades-temporales.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-21b5a722", Component.options)
  } else {
    hotAPI.reload("data-v-21b5a722", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchSedes: function fetchSedes() {
            var _this = this;

            var url = window.location.pathname.split("/");
            this.idClient = url[2];
            this.novedad.idCliente = url[2];
            axios.get('/sedes/cliente/' + this.idClient).then(function (res) {
                if (res.data.length === 0) {
                    _this.sedes.push({ nombre: 'Sede Única', id: 'unique' });
                    _this.idSede = '0';
                } else {
            ...
            document.getElementById('sedes').addEventListener('change', function (e) {
                axios.get('/temporales/novedad/' + _this.idClient + '/' + (e.target.value == 'unique' ? '0' : e.target.value)).then(function (res) {
                    _this.novedadesTemporales = res.data;
                }).catch(function (err) {
                    console.log(err);
                });
            });
        ...
        crear: function crear() {
            ...
            axios.post('/temporales/novedad', this.novedad).then(function (res) {
                _this2.novedadesTemporales.unshift(res.data);
                _this2.novedad.descripcion = '';
            }).catch(function (err) {
                console.log(err);
            });
        },
        completar: function completar(novedad) {
        ...
        eliminar: function eliminar(novedad) {
            var _this3 = this;

            axios.delete('/temporales/novedad/' + novedad.id).then(function (res) {
                var novedadIndex = _this3.novedadesTemporales.indexOf(novedad);
                _this3.novedadesTemporales.splice(novedadIndex, 1);
            }).catch(function (err) {
                console.log(err);
            });
        }
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "row", staticStyle: { margin: "auto", padding: "0 15px" } },
    [
      _c(
        "div",
        { staticClass: "ibox-content", staticStyle: { padding: "0" } },
        [
          _vm._m(0),
          _vm._v(" "),
          _c(
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [_vm._v("Seleccionar sede")]
                  ),
                  _vm._v(" "),
                  _vm._l(_vm.sedes, function(sede) {
                    return _c(
                      "option",
                      { key: sede.id, domProps: { value: sede.id } },
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.novedad.descripcion,
                      expression: "novedad.descripcion"
                    }
                  ],
                  staticClass: "form-control",
                  attrs: { type: "text", placeholder: "Escriba la novedad" },
                  domProps: { value: _vm.novedad.descripcion },
                  on: {
                    keydown: function($event) {
                      if (
                        !("button" in $event) &&
                    ...
                    input: function($event) {
                      ...
                      _vm.$set(_vm.novedad, "descripcion", $event.target.value)
                    }
                  }
                }),
                _c("span", { staticClass: "input-group-btn" }, [
          ...
          _c("div", { staticClass: "col-md-12" }, [
            _c(
              "ul",
              { staticClass: "todo-list m-t small-list " },
              _vm._l(_vm.novedadesTemporales, function(novedad) {
                return _c("li", { key: novedad.id }, [
                  _c(
                    "div",
                    {
                      staticClass: "checkbox checkbox-success",
                    ...
                    [
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: novedad.completado,
                            expression: "novedad.completado"
                          }
                        ],
                        attrs: { type: "checkbox", id: "checkbox" },
                        domProps: {
                          checked: Array.isArray(novedad.completado)
                            ? _vm._i(novedad.completado, null) > -1
                            : novedad.completado
                        },
                        on: {
                          click: function($event) {
                            _vm.completar(novedad)
                          },
                          change: function($event) {
                            var $$a = novedad.completado,
                              $$el = $event.target,
                              $$c = $$el.checked ? true : false
                            if (Array.isArray($$a)) {
                              var $$v = null,
                      ...
                      _c(
                        "label",
                        {
                          class: { "todo-completed": novedad.completado },
                          staticStyle: { width: "80%" }
                        },
                        [_vm._v(_vm._s(novedad.descripcion))]
                      ),
                      _vm._v(" "),
                      _c(
                        "span",
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      [
        _c("h2", [_vm._v("Novedades Temporales")]),
        _vm._v(" "),
        _c("small", [_vm._v("Selecciona la sede para empezar.")])
      ]
    )
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-21b5a722", module.exports)
  }
}
